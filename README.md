...
For professional wall mounting, use the ([matrixportal wall mount from printables.com](https://www.printables.com/model/44541-adafruit-rgb-matrix-portal-wall-mount/) from [smtibor](https://www.printables.com/@smtibor_96853)
